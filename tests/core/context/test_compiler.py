...
from hal.core.context.baseline import collect_active_thread_slugs, collect_recalled_thread_slugs
...
async def test_compile_session_turn_selects_related_active_threads_for_baseline(
    ...
    context_registry.thread_snapshot.return_value = [
        ...
        },
        {
            ...
            "state_path": "threads/blog/STATE.md",
        },
    ]
    ...
    context_registry.thread_snapshot.return_value = [
        {
            ...
            "status": "active",
            "description": "low",
            "state_path": "threads/thread-low/STATE.md",
        },
        {
            "slug": "thread-high",
            "name": "High",
            "status": "active",
            "description": "high",
            "state_path": "threads/thread-high/STATE.md",
        },
        {
            "slug": "thread-mid",
            "name": "Mid",
            "status": "active",
            "description": "mid",
            "state_path": "threads/thread-mid/STATE.md",
        },
    ]
    context_registry.active_thread_entry_snapshot.return_value = [
        {
