...
def _build_debrief_confirmation(*, threads: list[str], confirm_timeout_s: float) -> str:
    from hal.core.engine.debrief import build_debrief_confirmation_message
...
def _estimate_history_tokens(history: list[dict[str, object]], *, model: str | None) -> int:
    from hal.core.engine.session_compaction import estimate_history_tokens
...
def _split_history_for_compaction(
    ...
    *,
    ...
    from hal.core.engine.session_compaction import split_history_for_compaction
...
def _normalize_checkpoint(text: str) -> str:
    from hal.core.engine.session_compaction import normalize_checkpoint
