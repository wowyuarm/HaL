...
const buttonVariants = cva(
  [
    ...
    'font-mono font-medium transition-colors duration-fast ease-standard',
  ...
  ],
  {
    variants: {
      variant: {
        primary: 'border-accent bg-accent text-hal-on-accent hover:brightness-95',
        secondary: 'border-border bg-hal-paper text-hal-primary hover:bg-hal-panel',
