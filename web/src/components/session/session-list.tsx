  ...
  return (
    <section className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        {sessions.length === 0 ? (
          <div
            className={cn('hal-paper rounded-lg', halPaperObjectVariants({ density: 'spacious' }))}
          >
...
function findSessionGroup(sessionId: string, sessions: SessionManifest[]): SessionGroupId | null {
